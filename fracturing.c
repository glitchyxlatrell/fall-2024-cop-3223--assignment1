...
double findDistance(){
    //function that gets the distance between two points, but only outputs the position of the points and returns the distance value
...
double calculatePerimeter(){
    ...
    double radius = findDistance()/2;   //using calculateDistance function to get diameter then dividing by half to find radius
    double perimeter = 2*PI*radius;     //finding perimeter
...
double calculateArea(){
    ...
    double radius = findDistance()/2;   //using calculateDistance function to get diameter then dividing by half to find radius
    double area = PI*pow(radius,2);     //calculating the area of the cirlce given two points
...
double calculateWidth(){
    double width = findDistance();      //since width is equal to diameter, width is set equal to the return of findDistance
...
double calculateHeight(){
    double height = findDistance();      //since height is equal to diameter, width is set equal to the return of findDistance
